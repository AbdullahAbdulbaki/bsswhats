				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-10 col-md-8 col-lg-4 col-xl-3">
                                ...
                                <h6 class="s-17 w-700">{!! $settings['joinus_heading'] !!}</h6>
                                <h6 class="s-17 w-500">{!! $settings['joinus_description'] !!}</h6>
						...
						<div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
							...
							<div class="col">
								<div class="footer-copyright">
									<p class="p-sm"><span>&copy; {{date('Y')}} {{ (App\Models\Utility::getValByName('footer_text')) ? App\Models\Utility::getValByName('footer_text') :config('app.name', 'WhatsStore SaaS') }}</span>&nbsp;&nbsp;<span>All Rights Reserved</span></p>
								</div>
							</div>
