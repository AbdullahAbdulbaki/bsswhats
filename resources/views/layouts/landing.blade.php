...
<html lang="en">
	...
	<body>
			...
			<header id="header" class="hidden-nav tra-menu navbar-dark white-scroll">
				<div class="header-wrapper">
				    ...
				    <div class="wsmobileheader clearfix">
				    	<span class="smllogo"><img src="{{ asset('public/images_23/logo-skyblue.png') }}" alt="mobile-logo"></span>
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						<a href="#hero-23" class="logo-black"><img src="{{ asset('public/images_23/logo-skyblue.png') }}" alt="logo"></a>
	    					</div>


	    					<!-- HEADER WHITE LOGO -->
	    					<div class="desktoplogo">
	    						<a href="#hero-23" class="logo-white"><img src="{{ asset('public/images_23/logo-skyblue-white.png') }}" alt="logo"></a>
	    					</div>
	        						...
	        						<!-- DROPDOWN SUB MENU -->
						          	<li aria-haspopup="true"><a href="#" class="h-link">About <span class="wsarrow"></span></a>
	            						<ul class="sub-menu">
	            							...
	            							<li aria-haspopup="true"><a href="#features-12">Best Solutions</a></li>
	            							<li aria-haspopup="true"><a href="#features-5">Integrations</a></li>
					...
					<div class="row">
						<div class="col">
							<div class="hero-23-img video-preview wow fadeInUp">
								...
								<!-- Preview Image -->
								<img class="img-fluid" src="public/images_23/dashboard-03.png" alt="video-preview">
						...
						<div class="col text-center">
							...
							<div class="owl-carousel brands-carousel-6">
								...
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-1.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-2.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-3.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-4.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-5.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-6.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-7.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-8.png" alt="brand-logo"></a>
								</div>


								<!-- BRAND LOGO IMAGE -->
								<div class="brand-logo">
									<a href="#"><img class="img-fluid" src="public/images_23/brand-9.png" alt="brand-logo"></a>
								</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="img-block left-column wow fadeInRight">
								<img class="img-fluid" src="public/images_23/img-07.png" alt="content-image">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="txt-block right-column wow fadeInLeft">
								...
								<div class="txt-box mb-0">
									...
									<!-- Link -->
									<div class="txt-block-tra-link mt-25">
										<a href="#features-11" class="tra-link ico-20 color--theme">
											Automatic workflows <span class="flaticon-next"></span>
										</a>
									</div>
							...
							<div class="col-md-6">
								<div class="fbox-5 fb-1 gr--smoke r-16 wow fadeInUp">
									...
									<div class="fbox-5-img order-first order-md-2">
										<img class="img-fluid" src="public/images_23/f_06.png" alt="feature-image">
									</div>
							...
							<div class="col-md-6">
								<div class="fbox-5 fb-2 gr--smoke r-16 wow fadeInUp">
									...
									<div class="fbox-5-img">
										<img class="img-fluid" src="public/images_23/f_04.png" alt="feature-image">
									</div>
					...
					<div class="row">
						<div class="col">
							<div class="img-block video-preview wow fadeInUp">
								...
								<!-- Preview Image -->
			 					<img class="img-fluid" src="public/images_23/dashboard-02.png" alt="video-preview">
							...
							<div class="row">
								...
								<div class="col">
									<div class="banner-16-txt text-center">
										...
										<!-- Text -->
										<p class="p-md mb-0">Sodales tempor sapien quaerat ipsum undo congue laoreet
											turpis neque auctor turpis vitae dolor luctus placerat magna cursus
										</p>

										<!-- Link -->
										<div class="txt-block-tra-link mt-15">
											<a href="pricing-1.html" class="tra-link ico-20 color--theme">
												Discover our pricing <span class="flaticon-next"></span>
											</a>
										</div>
					...
					<div class="row">
						...
						<div class="col-xl-3">
							<div class="footer-info">
								<img class="footer-logo" src="public/images_23/logo-skyblue.png" alt="footer-logo">
							</div>
						</div>
		...
		<script src="{{asset('public/js_23/bootstrap.min.js')}}"></script>
