...
<div class="header-wrapper">
    ...
    <div class="ms-auto">
        <ul class="list-unstyled">
                    ...
                    @can('Create Store')
                        <li class="dropdown dash-h-item drp-language">
                            <a href="#!" class="dash-head-link dropdown-toggle arrow-none me-0 cust-btn" data-size="lg"
                                ...
                                <span class="drp-text hide-mob">{{ __('Create New Store') }}
                            </a>
                        </li>
            ...
            @endauth
               <li class="dropdown dash-h-item drp-language">
                            <a target="_blank" href="{{ $store_id['store_url']}}" class="dash-head-link dropdown-toggle arrow-none me-0 cust-btn"><i class="fas fa-eye"></i> <span class="drp-text hide-mob">{{__('View Store')}}</span></a>
                        </li>      
            @if (Auth::user()->type != 'super admin')
                <li class="dropdown dash-h-item drp-language">
