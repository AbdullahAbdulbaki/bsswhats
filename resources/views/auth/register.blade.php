         ...
         <div>
								...
								<div class="col-md-12">
									<div class="register-form-title">
										<h3 class="s-32 w-700">{{ __('Register') }}</h3>
										<p class="p-md">{{ __('Already have an account?') }}  <a href="{{ route('login', $lang) }}" class="color--theme">{{ __('Login') }}</a></p>
									</div>
								</div>


								<!-- SIGN UP FORM -->
								<form method="POST" action="{{ route('register') }}" class="needs-validation row sign-up-form" novalidate="" >
								@csrf

									<!-- Google Button -->	
									<div class="col-md-12">
										<a  href="#" class="btn btn-google ico-left">
											<img src="{{ asset('public/images_23/png_icons/google.png')}}" alt="google-icon"> Sign up with Google
										</a>
									</div>  
									...
									<div class="form-group mb-3">
										...
										<input class="form-control name @error('name') is-invalid @enderror" name="name" type="text" value="{{ old('name') }}" required autocomplete="name" autofocus
				                    ...
				                    <div class="form-group mb-3">
                                         <p class="p-sm input-header">{{ __('Store Name') }}</p>
