        ...
        if (\Auth::user()->can('Create Products')) {
            ...
            $validator = \Validator::make(
                ...
                [
                    ...
                    'is_cover_image' => 'nullable|file|max:500', // Maximum size of 500 kilobytes
                    'downloadable_prodcut' => 'nullable|file|max:500', // Maximum size of 500 kilobytes
                ],
                [
                    'is_cover_image.max' => __('The cover image may not be greater than 500 kilobytes.'),
                    'downloadable_prodcut.max' => __('The downloadable product may not be greater than 500 kilobytes.'),
                ]
            );
