...
$translatedLabels = array_map(function($label) {
    return \Stichoza\GoogleTranslate\GoogleTranslate::trans($label, app()->getLocale());
}, $chartData['label']);
?>
<?php $__env->startPush('script-page'); ?>
    <script>
            ...
            (function() {
                var options = {
                    ...
                    xaxis: {
                        ...
                        type: "MMM",
                        categories: <?php echo json_encode($translatedLabels); ?>,
                        title: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsswhats/public_html/resources/views/home.blade.php ENDPATH**/ ?>