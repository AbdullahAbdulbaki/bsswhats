...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <?php if(Auth::user()->type == 'super admin'): ?>
                ...
                <li
                    ...
                    <ul
                        class="dash-submenu <?php echo e(Request::segment(1) == 'blog_categories' || Request::segment(1) == 'blog_backend' ? ' show' : ''); ?>">

                            <li class="dash-item <?php echo e(Request::route()->getName() == 'blog_categories' ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('blog_categories.index')); ?>"><?php echo e(__('Blog Categories')); ?></a>
                            </li>

                            <li
                                class="dash-item <?php echo e(Request::segment(1) == 'blog_backend.index' || Request::route()->getName() == 'blog_backend.create' || Request::route()->getName() == 'blog_backend.edit' ? ' active dash-trigger' : 'collapsed'); ?>">
                                <a class="dash-link" href="<?php echo e(route('blog_backend.index')); ?>"><?php echo e(__('Blog')); ?></a>
                            </li>
        ...
        <li
          class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'configurations' || Request::route()->getName() == 'store.grid' ? ' active dash-trigger' : 'collapsed'); ?> dash-trigger">
          <a href="#!" class="dash-link">
            <span class="dash-micon">
              <i class="ti ti-home"></i>
            </span>
            <span class="dash-mtext"><?php echo e(__('Affiliate')); ?></span>
            <span class="dash-arrow dash-trigger">
          ...
          <ul class="dash-submenu  show" style="box-sizing: border-box; display: block;">
 
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage affiliate_configurations')): ?>
              <li
                class="dash-item <?php echo e(Request::segment(1) == 'configurations' || Request::route()->getName() == 'store.grid' ? ' active' : 'collapsed'); ?>">
                <a href="<?php echo e(route('affiliate.configurations')); ?>"
                  class="dash-link <?php echo e(request()->is('affiliate') ? 'active' : ''); ?>">
                  <?php echo e(__('Configurations')); ?>

                </a>
              </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage affiliate_withdraw')): ?>
              <li
                class="dash-item <?php echo e(Request::segment(2) == 'withdraw-requests' || Request::route()->getName() == 'store.grid' ? ' active' : 'collapsed'); ?>">
                <a href="<?php echo e(route('affiliate.withdraw.index')); ?>"
                  class="dash-link <?php echo e(request()->is('withdraw-requests') ? 'active' : ''); ?>">
                  <?php echo e(__('Withdraw Requests')); ?>

                </a>
              </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage affiliate_earning_histories')): ?>
              <li
                class="dash-item <?php echo e(Request::segment(2) == 'earning-histories' || Request::route()->getName() == 'store.grid' ? ' active' : 'collapsed'); ?>">
                <a href="<?php echo e(route('affiliate.earnings.index')); ?>"
                  class="dash-link <?php echo e(request()->is('earning-histories') ? 'active' : ''); ?>">
                  <?php echo e(__('Earnings')); ?>

                </a>
              </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage affiliate_payment_histories')): ?>
              <li
                class="dash-item dash-hasmenu <?php echo e(Request::segment(2) == 'payments' || Request::route()->getName() == 'store.grid' ? ' active dash-trigger' : 'collapsed'); ?>">
                <a href="<?php echo e(route('affiliate.payments.index')); ?>"
                  class="dash-link <?php echo e(request()->is('payments') ? 'active' : ''); ?>">
                  <?php echo e(__('payment Histories')); ?>
            ...
            <?php else: ?>
                ...
                <li
          class="dash-item dash-hasmenu <?php echo e(Request::segment(2) == 'affiliate' || Request::segment(2) == 'storeanalytic' || Request::route()->getName() == 'orders.show' ? ' active dash-trigger' : 'collapsed'); ?>">
          <a href="#!" class="dash-link ">
            <span class="dash-micon">
              <i class="ti ti-home"></i>
            </span>
            <span class="dash-mtext"><?php echo e(__('Affiliate System')); ?></span>
            <span class="dash-arrow">
              <i data-feather="chevron-right"></i>
            </span>
          </a>
          <ul
            class="dash-submenu <?php echo e(Request::segment(2) == 'configure-payouts' || Request::segment(2) == 'storeanalytic' ? ' show' : ''); ?>">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage affiliate_overview')): ?>
              <li class="dash-item <?php echo e(Request::route()->getName() == 'affiliate.overview' ? ' active' : ''); ?>">
                <a class="dash-link" href="<?php echo e(route('affiliate.overview')); ?>"><?php echo e(__('overview')); ?></a>
              </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage payout_configurations')): ?>
              <li class="dash-item <?php echo e(Request::route()->getName() == 'affiliate.payout.configure' ? ' active' : ''); ?>">
                <a class="dash-link"
                  href="<?php echo e(route('affiliate.payout.configure')); ?>"><?php echo e(__('Payout Configurations')); ?></a>
              </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage affiliate_earnings')): ?>
              <li class="dash-item <?php echo e(Request::route()->getName() == 'affiliate.earnings.index' ? ' active' : ''); ?>">
                <a class="dash-link" href="<?php echo e(route('affiliate.earnings.index')); ?>"><?php echo e(__('Earnings Histories')); ?></a>
              </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage withdraw_requests')): ?>
              <li class="dash-item <?php echo e(Request::route()->getName() == 'affiliate.withdraw.index' ? ' active' : ''); ?>">
                <a class="dash-link" href="<?php echo e(route('affiliate.withdraw.index')); ?>"><?php echo e(__('Withdraw Requests')); ?></a>
              </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage payment_histories')): ?>
              <li class="dash-item <?php echo e(Request::route()->getName() == 'affiliate.payments.index' ? ' active' : ''); ?>">
                <a class="dash-link" href="<?php echo e(route('affiliate.payments.index')); ?>"><?php echo e(__('Payment Histories')); ?></a>
              </li>
            <?php endif; ?>
          </ul>
        </li>
...
<?php /**PATH /home/bsswhats/public_html/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>