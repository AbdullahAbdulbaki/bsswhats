...
<head>
    ...
    <meta property="og:image" content="<?php echo e($meta_image . '/' . $store->meta_image); ?>">
    ...
    <meta property="twitter:image" content="<?php echo e($meta_image . '/' . $store->meta_image); ?>">
    ...
    <?php if(isset($settings['SITE_RTL']) && $settings['SITE_RTL'] == 'on'): ?>
        <?php if(!empty($store->store_theme)): ?>
            <link rel="stylesheet" href="<?php echo e(asset('custom/css/rtl/rtl-' . $store->store_theme . '.css')); ?>" id="stylesheet">
    ...
    <link rel="apple-touch-icon" href="<?php echo e($logo1 . (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'favicon.png')); ?>" />
    <?php if($store->enable_pwa_store == 'on'): ?>
    <link rel="manifest" href="<?php echo e(asset('storage/uploads/customer_app/store_' . $store_settings->id . '/manifest.json')); ?>" />
    <?php endif; ?>
    ...
    <?php $__currentLoopData = $pixelScript; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $script): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?= $script ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</head>
                    ...
                    <div class="col-lg-10 col-12 floating-nav">
                        <div class="navbar-container d-flex align-items-center justify-content-between">
                            ...
                            <a href="#" class="nav-brand nav-logo">
                                <img src="<?php echo e($s_logo . (isset($store_settings['logo']) && !empty($store_settings['logo']) ? $store_settings['logo'] : 'logo.png') . '?timestamp=' . time()); ?>"
                                    class="header_img grey-bg" >
                            </a>
                            <a href="#" class="nav-brand nav-tagline d-none">
                                <h2 class="nav-title"><?php echo e($store->name); ?></h2>

                                <span class="sub-text"><?php echo e($store->storeAddress($store->address)); ?>

                                    <?php echo e($store->storeAddress($store->city)); ?> <?php echo e($store->storeAddress($store->state)); ?>

                                    <?php echo e($store->storeAddress($store->country, 'country')); ?></span>
                            </a>
...
<?php if(Auth::user()->type != 'super admin'): ?>
                <li class="dropdown dash-h-item drp-language">
                                        <li class="nl-simple" aria-haspopup="true" style="margin-top: 14px;width:40px">
            ...
            <?php else: ?>
                <li class="dropdown dash-h-item drp-language">
                    <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                        ...
                        <span class="drp-text"><?php echo e(Str::ucfirst($currantLang)); ?></span>
            ...
            <?php endif; ?>
                                ...
                                <form class="search-input" action="/action_page.php">
                                    <a href="#" class="search-icon">
                                        <img src="<?php echo e(asset('custom/images/search-icon-black-body.svg')); ?>"
                                            alt="#">
                                    </a>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <?php if(Utility::CustomerAuthCheck($store->slug) == false): ?>
                                                        <a data-url="<?php echo e(route('customer.login', $store->slug)); ?>"
                                                            data-title="<?php echo e(__('Login')); ?>"><?php echo e(__('Login')); ?></a>
                                                    <?php else: ?>
                                ...
                                <?php else: ?>
                                    <a data-url="<?php echo e(route('customer.login', $store->slug)); ?>" data-ajax-popup="true"
                                        data-title="<?php echo e(__('Login')); ?>" data-toggle="modal"
                                ...
                                <div class="row">
                                    <div class="col-xl-8 col-lg-12 col-12">
                                        <div class="card-header card-header-main">
                                            ...
                                            <h4 class="card-title main-title"><?php echo e(__('Products')); ?></h4>
                                            <div class="right-area">
                                                ...
                                                <div class="filter-by">
                                                    ...
                                                    <div class="nice-select" tabindex="0">
                                                        <span class="current"><?php echo e(__('Price')); ?> </span>
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-12 right-card">
                                        ...
                                        <div class="card">
                                            <h4 class="card-header card-title coupon-title"><?php echo e(__('Coupon')); ?></h4>
                                            <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group product-detail apply-stripe-btn-coupon">
                                                    <a href="#"
                                                        class="btn btn-secondary apply-coupon btn-sm"><?php echo e(__('Apply')); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <table class="cart-tble">
                                                        <tbody>
                                                            <?php $__currentLoopData = $pro_cart['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <tr
                                                                        ...
                                                                        <div class="title_name">
                                                                            ...
                                                                            <td class="price-spin">
                                                                                <b class="subtotal"
                                                                                    id="product-variant-id-<?php echo e($product['variant_id']); ?>">
                                                                                    <?php echo e(\App\Models\Utility::priceFormat($product['variant_price'] * $product['quantity'])); ?></b>
                                                                                <?php echo Form::open([
                                                                                    'method' => 'DELETE',
                                                                ...
                                                                <?php else: ?>
                                                                    <tr id="product-id-<?php echo e($product['product_id']); ?>">
                                                                        <td data-label="Product">
                                                                            <a href="#" class="pro-img-cart">
                                                                                <img
                                                                                    src="<?php echo e(asset($product['image'])); ?>">
                                                                        ...
                                                                        <td data-label="Name">
                                                                            <a
                                                                                href="#"><?php echo e($product['product_name']); ?></a>
                                                                        </td>
                                                                        <?php
                                                                            $total_tax = 0;
                                                                        ?>
                                                                        ...
                                                                        <td data-label="Total">
                                                                            <b class="subtotal"
                                                                                id="product-id-<?php echo e($product['product_id']); ?>">
                                                                                <?php echo e(\App\Models\Utility::priceFormat($product['price'] * $product['quantity'])); ?></b>
                                                                            <?php echo Form::open([
                                                                                'method' => 'DELETE',
                                                                                'route' => ['delete.cart_item', $store->slug, $product['id'], $product['variant_id']],
                                                                            ]); ?>
                                                ...
                                                <div class="card-footer">
                                                    <div class="invoice-details">
                                                        <ul class="invoice-list">
                                                            ...
                                                            <?php if(!empty($pro_cart) && count($pro_cart['products']) > 0): ?>
                                                                <li class="invoice-detail">
                                                                    ...
                                                                    <div class="invoice-amt">
                                                                        <span
                                                                            class="invoice-amt shipping_price"><?php echo e(__('0.00')); ?></span>
                                                                    </div>
                                                                </li>
                                                            <?php endif; ?>
                                                            <?php if(!empty($taxArr)): ?>
                                                                <?php $__currentLoopData = $taxArr['tax']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <div
                                                                        class="invoice-amt total_tax_<?php echo e($k); ?>">
                                                                        <?php echo e(\App\Models\Utility::priceFormat($taxArr['rate'][$k])); ?>
                                                            ...
                                                            <li class="invoice-detail">
                                                                <div class="invoice-title total-title ">
                                                                    <h4><?php echo e(__('Total (Incl Tax)')); ?></h4>
                                                                </div>
                                        ...
                                        <div class="card delivery-card">
                                            <div class="card-header">
                                                <h4 class="card-title coupon-title"><?php echo e(__('Delivery Details')); ?></h4>
                                            </div>
                                            <div class="card-body detail-form">
                                                ...
                                                <?php if(!empty($store->custom_field_title_1)): ?>
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('custom_field_title_1', old('custom_field_title_1'), ['class' => 'active custom_field_title_1'])); ?>
                                                ...
                                                <?php if(!empty($store->custom_field_title_2)): ?>
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('custom_field_title_2', old('custom_field_title_2'), ['class' => 'active custom_field_title_2'])); ?>
                                                ...
                                                <?php if(!empty($store->custom_field_title_3)): ?>
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('custom_field_title_3', old('custom_field_title_3'), ['class' => 'active custom_field_title_3'])); ?>
                                                ...
                                                <?php if(!empty($store->custom_field_title_4)): ?>
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('custom_field_title_4', old('custom_field_title_4'), ['class' => 'active custom_field_title_4'])); ?>
                                                        ...
                                                        <div class="card">
                                                            <div class="form-group">
                                                                <h4 class="card-header card-title coupon-title">
                                                                    <?php echo e(__('Shipping Location')); ?></h4>
                                                            </div>
                                                            <div class="card-body">
                                        ...
                                        <div class="card instruction-card">
                                            <div class="card-header">
                                                <h4 class="card-title coupon-title"><?php echo e(__('Order Notes')); ?></h4>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="order-md-1 text-center" style="border: 0; padding:0;">
                                            <?php if(
                                                ...
                                                <a href="#" class="btn checkoutBtn" data-toggle="modal" id="checkoutBtn"
                                                    ...
                                                    <span class="text-primary"><?php echo e(__('Proceed to checkout')); ?></span>
                                            ...
                                            <div
                                                ...
                                                <?php if($store->enable_whatsapp == 'on'): ?>
                                                    <button type="submit" class="btn whatsap-btn payment"
                                                        ...
                                                        <span><?php echo e(__('Order on WhatsApp')); ?></span>
                                                    </button>
                                                <?php endif; ?>
                                                ...
                                                <?php if($store->enable_telegram == 'on'): ?>
                                                    <button type="submit" class="btn telegram-btn"
                                                        ...
                                                        <span><?php echo e(__('Order on Telegram')); ?></span>
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="btn-leb">
                                                <?php if($store['enable_cod'] == 'on'): ?>
                                                    <button type="submit" class="btn " id="cash_on_delivery">
                                                        <span><?php echo e(__('Order on COD')); ?></span>
                                                    </button>
                                                <?php endif; ?>
                                                ...
                                                <?php if(isset($store_payments['is_stripe_enabled']) && $store_payments['is_stripe_enabled'] == 'on'): ?>
                                                    <div class="card-btn" id="paymentsBtn">
                                                        <form role="form"
                                                            action="<?php echo e(route('stripe.post', $store->slug)); ?>"
                                                    ...
                                                    <form role="form" class="payfast-form"
                                                        ...
                                                        <div class="card-btn">
                                                            ...
                                                            <button type="button" class="btn"
                                                                onclick="payPayfast()"
                                                                id="payfast-get-status"><?php echo e(__('Pay via Payfast')); ?></button>
                                                        </div>
                                                    </form>
                                                <?php endif; ?>
                                                    ...
                                                    <div class="payment-method card-btn">
                                                        <div class="upload-btn-wrapper">
                                                            <form method="POST"
                                                                ...
                                                                <input type="hidden" name="transaction_id"
                                                                    value="<?php echo e(date('Y-m-d') . strtotime('Y-m-d H:i:s')); ?>">
                                                                <input type="hidden" name="desc"
                                                                    value="<?php echo e(time()); ?>">
                                                            </form>
                                                        </div>
                            ...
                            <div class="conteiner">
                                ...
                                <div class="copyright d-flex align-items-center justify-content-between"
                                    ...
                                    <div class="text-store">
                                        <p class="<?php echo e(env('SITE_RTL') == 'on' ? 'text-center' : 'text-left'); ?>">
                                            <?php echo e($store->footer_note); ?></p>
                                    </div>
                                    <div class="icone-store">
                                        <ul
                                            class="nav <?php echo e(env('SITE_RTL') == 'on' ? 'm-auto float-left' : 'float-right text-left'); ?>">
                                            <?php if(!empty($store->youtube)): ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="<?php echo e($store->youtube); ?>"
                                                        target="<?php echo e($store->youtube != '#' ? '_blank' : ''); ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <?php if(!empty($store->email)): ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="mailto:<?php echo e($store->email); ?>"
                                                        target="”_blank”">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                            version="1.1" id="Capa_1" x="0px"
                                            ...
                                            <?php if(!empty($store->facebook)): ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="<?php echo e($store->facebook); ?>"
                                                        target="<?php echo e($store->facebook != '#' ? '_blank' : ''); ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1"
                                            ...
                                            <?php if(!empty($store->instagram)): ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="<?php echo e($store->instagram); ?>"
                                                        target="<?php echo e($store->instagram != '#' ? '_blank' : ''); ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                            version="1.1" id="Capa_1" x="0px"
                                            ...
                                            <?php if(!empty($store->twitter)): ?>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="<?php echo e($store->twitter); ?>"
                                                        target="<?php echo e($store->twitter != '#' ? '_blank' : ''); ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                            version="1.1" id="Capa_1" x="0px"
                                                            y="0px" viewBox="0 0 512 512"
                                            ...
                                            <?php if(!empty($store->whatsapp)): ?>
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="https://wa.me/<?php echo e($store->whatsapp); ?>"
                                                        target="_blank">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                            version="1.1" id="Capa_1" x="0px"
    ...
    <div class="modal modal-content modal-popup d-flex align-items-center" id="checkoutModal">
        <div class="modal-content-inner">
            <div class="modal-header align-items-center">
                <div class="modal-title">
                    <h6 class="mb-0" id="modelcheckoutModalLabel"><?php echo e(__('Proceed To Checkout')); ?></h6>
                </div>
                <button type="button" class="close close-button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            ...
            <div class="modal-body row">
                ...
                <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0 asGuest">
                    <a href="#footer"
                        class="btn btn-secondary btn-light rounded-pill"><?php echo e(__('Continue as guest')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<script>
        var baseUrl = "<?php echo e(route('change.language', ['lang' => '__lang__'])); ?>";

        function updateFormAction(select) {
            var selectedOption = select.value;
            var form = document.getElementById('languageForm');
            form.action = baseUrl.replace('__lang__', selectedOption);
            form.submit();
        }
    </script>
</body>
...
<?php /**PATH /home/bsswhats/public_html/resources/views/storefront/theme_1_to_6/index.blade.php ENDPATH**/ ?>