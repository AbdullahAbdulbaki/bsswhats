        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo e(Form::textarea('faq_answer', null, ['class' => 'form-control summernote', 'id' => 'classic-editor', 'rows' => '5' ,'placeholder' => __('Enter Answer')])); ?>
...
<?php /**PATH /home/bsswhats/public_html/Modules/LandingPage/Resources/views/landingpage/faq/create.blade.php ENDPATH**/ ?>