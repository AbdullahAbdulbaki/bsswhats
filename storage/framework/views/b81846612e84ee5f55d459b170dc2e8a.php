							...
							<div class="register-page-form">
								...
								<div class="col-md-12">
									<div class="register-form-title">
										<h3 class="s-32 w-700"><?php echo e(__('Log in to BSSWHATS')); ?></h3>
										<?php if((!empty($settings['signup_button']) ? $settings['signup_button'] : '') == 'on'): ?>
                                        <p class="p-md">
                                            <?php echo e(__("Don't have an account?")); ?>

                                            <a href="<?php echo e(route('register', $lang)); ?>" class="color--theme"><?php echo e(__('Register')); ?></a>
                                        </p>
                                        <?php endif; ?>
									</div>
								</div>
								...
								<!-- LOGIN FORM -->
								<form method="POST" action="<?php echo e(route('login')); ?>" id="form_data" class="needs-validation row sign-in-form" novalidate="">
                                    <?php echo csrf_field(); ?>
									<!-- Google Button -->	
									<div class="col-md-12">
										<a  href="#" class="btn btn-google ico-left">
											<img src="<?php echo e(asset('public/images_23/png_icons/google.png')); ?>" alt="google-icon"> Sign in with Google
										</a>
									</div>  
									...
									<div class="col-md-12">
                                        ...
                                        <input id="email" type="email" class="form-control email  <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php endif; ?>
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn--theme hover--theme submit" id="login_button"><?php echo e(__('Login')); ?></button>
                                </div>
                                </form>
							</div>	
						</div>	
...
<?php /**PATH /home/bsswhats/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>