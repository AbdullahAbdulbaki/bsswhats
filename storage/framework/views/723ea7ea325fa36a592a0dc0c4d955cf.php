					 		...
					 		<div class="col-md-6 col-lg-4">
					 			<div class="blog-post mb-40 wow fadeInUp clearfix">
					 				...
					 				<div class="blog-post-img mb-35">
										<img class=" r-16" src="<?php echo e(asset('landing/blogs_super_admin/' . $blog->img)); ?>" height="500" width="500" alt="blog-post-image">
									</div>
									...
									<div class="blog-post-txt">
										...
										<!-- Post Tag -->
										<span class="post-tag color--pink-400"><?php echo e($blog->category->name); ?></span>

										<!-- Post Link -->
										<h6 class="s-20 w-700">
											<a href="<?php echo e(route('apps.show_blog', $blog->id)); ?>"><?php echo e($blog->title); ?>
										...
										<div class="blog-post-meta mt-20">
											<ul class="post-meta-list ico-10">
												...
												<li><p class="p-sm"><?php echo e(date('j M, Y',strtotime($blog->created_at))); ?></p></li>
											</ul>
										</div>
...
<?php /**PATH /home/bsswhats/public_html/Modules/LandingPage/Resources/views/layouts/blogs.blade.php ENDPATH**/ ?>