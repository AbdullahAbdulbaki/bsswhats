...
<body class="<?php echo e($themeColor); ?>">
    ...
    <script>
    $(document).ready(function() {
        // Call functions to set up theme and dark layout if elements exist
        if ($('#cust-theme-bg').length) {
            cust_theme_bg();
        }
        if ($('#cust-dark-layout').length) {
            cust_darklayout();
        }
        ...
        if (pctoggle) {
            pctoggle.addEventListener("click", function() {
                var customizer = document.querySelector(".pct-customizer");
                if (customizer) {
    ...
    function cust_darklayout() {
        // Assuming cust_darklayout function is similar and needs similar checks
        var darkLayoutToggle = document.querySelector("#cust-dark-layout");
        if (darkLayoutToggle) {
            // Add your dark layout logic here
            darkLayoutToggle.addEventListener("click", function() {
                if (darkLayoutToggle.checked) {
...
<?php /**PATH /home/bsswhats/public_html/resources/views/layouts/admin.blade.php ENDPATH**/ ?>