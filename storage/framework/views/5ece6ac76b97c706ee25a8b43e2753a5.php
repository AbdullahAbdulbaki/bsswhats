						...
						<div class="col-md-6">
							<div class="txt-block right-column wow fadeInLeft">
								...
								<div class="txt-box mb-0">
									...
									<!-- Link -->
									<div class="txt-block-tra-link mt-25">
										<a href="<?php echo e(route('register')); ?>" class="tra-link ico-20" style="color:#FE4A65">
								...
								<div class="cbox-4">
									...
									<!-- Icon & Title -->
		 							<div class="box-title">
										...
										<a href="<?php echo e(route('register')); ?>"><h5 class="s-24 w-700">Get Started Free Today!</h5></a>
									</div>
								...
								<div class="col-md-8">
									<div class="banner-7-txt text-center">
										...
										<div class="btns-group">
											<a href="<?php echo e(route('register')); ?>" class="btn r-04  hover--theme" style="color:white;background-color:#FE4A65">Get srarted - it's free
											</a>
...
<?php /**PATH /home/bsswhats/public_html/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>