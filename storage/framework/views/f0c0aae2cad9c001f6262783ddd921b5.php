        ...
        <ul class="list-unstyled mb-0 m-2">
            <li class="dropdown dash-h-item drp-language">
                <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                    ...
                    <span class="drp-text hide-mob text-primary"><?php echo e(__('Locale: ')); ?><?php echo e(Str::ucfirst($languages[$currEmailTempLang->lang])); ?></span>
                ...
                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end" aria-labelledby="dropdownLanguage">
                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('manage.email.language', [$emailTemplate->id, $code])); ?>"
                            class="dropdown-item <?php echo e($currEmailTempLang->lang == $code ? 'text-primary' : ''); ?>"><?php echo e(Str::ucfirst($lang)); ?></a>
                            ...
                            <div class="card">
                                <div class="    card-body">
                                    <div class="row text-xs">
                                            <?php if($emailTemplate->name != "Owner Created"): ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <p class="mb-1"><?php echo e(__('Owner Name')); ?> : <span
                                                        class="pull-right text-primary">{owner_name}</span></p>
                                                <p class="mb-1"><?php echo e(__('Owner Email')); ?> : <span
                                                        class="pull-right text-primary">{owner_email}</span></p>
                                                <p class="mb-1"><?php echo e(__('Owner Password')); ?> : <span
                                                        class="pull-right text-primary">{owner_password}</span></p>
                                                <p class="mb-1"><?php echo e(__('Store URL')); ?> : <span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsswhats/public_html/resources/views/email_templates/show.blade.php ENDPATH**/ ?>