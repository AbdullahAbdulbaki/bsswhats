    ...
    <script>
        ...
        function updateImagePreview(inputElement) {
            ...
            if (inputElement.files.length > 0) {
                ...
                imageElement.src = '<?php echo e($logo . '/placeholder.png'); ?>';
            }
        }
            ...
            <div class="row">
                ...
                <div>
                    <div class="card">
                        ...
                        <?php echo e(Form::open(['route' => 'homesection.store', 'method' => 'post', 'id' => 'imageUploadForm', 'enctype' => 'multipart/form-data'])); ?>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="<?php echo e($logo.'/site_logo.png'); ?>" width="70px" alt="Image placeholder" data-dz-thumbnail="">
                                            ...
                                            <div class="card mb-3 border shadow-none product_Image">
                                                <div class="px-2 py-2">
                                                    <div class="row align-items-center">
                                                        <div class="col ml-n2">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="<?php echo e($logo.'/'.$home_logo); ?>" width="70px" alt="Image placeholder" data-dz-thumbnail="">
                                                            </p>
                                                        </div>
                                                        <div class="col-auto actions">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsswhats/public_html/Modules/LandingPage/Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>