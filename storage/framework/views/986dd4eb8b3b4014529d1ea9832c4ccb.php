...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        function showNextInput() {
            const currentFieldIndex = parseInt(document.getElementById('currentFieldIndex').value);
            const nextFieldIndex = currentFieldIndex + 1;
            const nextField = document.getElementById('field_' + nextFieldIndex);
            const nextValue = document.getElementById('value_' + nextFieldIndex);
            if (nextField && nextValue) {
                nextField.style.display = 'block';
                nextValue.style.display = 'block';
                document.getElementById('currentFieldIndex').value = nextFieldIndex;
            }
        }
    </script>
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
                            ...
                            <div class="card shadow-none border border-primary">
                                <div class="card-body ">
                                    ...
                                    <div class="form-group proprice">
                                        <div class="row gy-4">
                                            <div class="col-md-6">
                                                ...
                                                <?php echo e(Form::number('price', null, ['step' => 'any', 'class' => 'form-control', 'placeholder' => __('Enter Price')])); ?>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <p style="color:red"><?php echo e(__('Maximum image size is 500 KB')); ?></p>
                                    </div>
                                    </form>
                                </div>
                            </div>
        ...
        <div class="card shadow-none border border-primary">
            <div class="card-body">
                <input type="hidden" id="currentFieldIndex" value="1">
                
                <div class="form-group" id="field_1" style="display: block;">
                    <?php echo e(Form::label('custom_field_1', __('Custom Field'), ['class' => 'form-label'])); ?>

                    <?php echo e(Form::text('custom_field_1', null, ['class' => 'form-control', 'placeholder' => __('Enter Custom Field'), 'required' => 'required'])); ?>

                </div>
                <div class="form-group" id="value_1" style="display: block;">
                    <?php echo e(Form::label('custom_value_1', __('Custom Value'), ['class' => 'form-label'])); ?>
                ...
                <div class="form-group" id="field_2" style="display: none;">
                    <?php echo e(Form::label('custom_field_2', __('Custom Field'), ['class' => 'form-label'])); ?>

                    <?php echo e(Form::text('custom_field_2', null, ['class' => 'form-control', 'placeholder' => __('Enter Custom Field'), 'required' => 'required'])); ?>

                </div>
                <div class="form-group" id="value_2" style="display: none;">
                    <?php echo e(Form::label('custom_value_2', __('Custom Value'), ['class' => 'form-label'])); ?>
                ...
                <div class="form-group" id="field_3" style="display: none;">
                    <?php echo e(Form::label('custom_field_3', __('Custom Field'), ['class' => 'form-label'])); ?>

                    <?php echo e(Form::text('custom_field_3', null, ['class' => 'form-control', 'placeholder' => __('Enter Custom Field'), 'required' => 'required'])); ?>

                </div>
                <div class="form-group" id="value_3" style="display: none;">
                    <?php echo e(Form::label('custom_value_3', __('Custom Value'), ['class' => 'form-label'])); ?>
                ...
                <div class="form-group" id="field_4" style="display: none;">
                    <?php echo e(Form::label('custom_field_4', __('Custom Field'), ['class' => 'form-label'])); ?>

                    <?php echo e(Form::text('custom_field_4', null, ['class' => 'form-control', 'placeholder' => __('Enter Custom Field'), 'required' => 'required'])); ?>

                </div>
                <div class="form-group" id="value_4" style="display: none;">
                    <?php echo e(Form::label('custom_value_4', __('Custom Value'), ['class' => 'form-label'])); ?>
                ...
                <button type="button" class="btn btn-primary" onclick="showNextInput()"><?php echo e(__('Add Custom Field')); ?></button>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsswhats/public_html/resources/views/product/create.blade.php ENDPATH**/ ?>