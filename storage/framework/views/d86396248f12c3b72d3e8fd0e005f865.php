...
<?php if($flag == 'my_orders'): ?>
    ...
    <div class="section-title d-flex align-items-center justify-content-between" style="margin:20px">
        <h4><b><?php echo e(__('Products you purchased')); ?></b></h4>
        <a href="" class="btn btn-secondary"><?php echo e(__('Back to home')); ?></a>
    </div>
            ...
            <tbody>
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_key => $order_items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <span
                                class="h6 text-sm font-weight-bold mb-0"><?php echo e(\App\Models\Utility::dateFormat($order_items->created_at)); ?></span>
                        </td>
                        <td>
                            <span
                                class="value text-sm mb-0"><?php echo e(\App\Models\Utility::priceFormat($order_items->price)); ?></span>
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="#"
                                data-url="<?php echo e(route('store.product.product_order_view', [$order_items->id, Auth::guard('customers')->user()->id, $store->slug])); ?>"
                                data-toggle="tooltip" class="view-btn" data-title="<?php echo e(__('Your Order Details')); ?>"
...
<?php else: ?>
    <div>
        ...
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div
                class="tab-content collection-items <?php echo e($loop->iteration != 1 ? 'd-none' : 'active'); ?> <?php echo e($loop->iteration); ?><?php echo str_replace(' ', '_', $key); ?> product_tableese">
                <div class="row o-gutters ">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 product-card theme-colored-card product_item"
                            data-name="<?php echo e($product->name); ?>">
                            <div class="product-card-inner">
                                <a href="#" class="img-like product_details_icon" data-size="lg"
                                ...
                                <div class="product-content">
                                    <div class="product-content-top">
                                        ...
                                        <div class="top-place-info">
                                            <div class="new-labl">
                                                <?php echo e(isset($product->categories) && !empty($product->categories) ? $product->categories->name : ''); ?>
                                    ...
                                    <div class="product-content-bottom">
                                        <?php if($product->enable_product_variant == 'on'): ?>
                                            <a href="#" class="variant-btn "><?php echo e(__('In Variant')); ?></a>
                                        <?php else: ?>
                                            <a href="#"
                                                class="variant-btn "><?php echo e(\App\Models\Utility::priceFormat($product->price)); ?></a>
                                        <?php endif; ?>
                                        <div class="product-btn">
                                            <?php if($flag != 'my_orders'): ?>
                                                <?php if($product->enable_product_variant == 'on'): ?>
                                                    <a href="#"
                                                        class="btn btn-addcart btn-secondary modal-target "
                                                        data-size="sm"
                                                        ...
                                                        id="add_to_cart"><?php echo e(__('Add To Cart')); ?>
...
<?php endif; ?>
<?php /**PATH /home/bsswhats/public_html/resources/views/storefront/theme_1_to_6/grid.blade.php ENDPATH**/ ?>