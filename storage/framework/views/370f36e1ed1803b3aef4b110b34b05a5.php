		...
		2: [function(require, module, exports) {
			...
			const r = function(t) {
				...
				l = {
					...
					footer: !1,
					labels: {
						placeholder: <?php echo json_encode(__('Search...'), 15, 512) ?>,
						perPage: `{select} <?php echo json_encode(__('entries per page'), 15, 512) ?>`,
						noRows: <?php echo json_encode(__('No entries found'), 15, 512) ?>,
						noResults: <?php echo json_encode(__('No results match your search query'), 15, 512) ?>,
						info: <?php echo json_encode(__('Showing {start} to {end} of {rows} entries'), 15, 512) ?>
					},
					layout: {
						top: "{select}{search}",
						bottom: "{info}{pager}"
...
<?php /**PATH /home/bsswhats/public_html/resources/views/partials/admin/footer.blade.php ENDPATH**/ ?>