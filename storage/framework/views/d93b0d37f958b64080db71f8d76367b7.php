<?php
    ...
    //get Store link
                    $store= Auth::user();
                    $store_id   = App\Models\Store::where('id', $store->current_store)->first();
                    if ($store_id) {
...
<div class="header-wrapper">
    ...
    <div class="ms-auto">
        <ul class="list-unstyled">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Store')): ?>
                        <li class="dropdown dash-h-item drp-language">
                            <a href="#!" class="dash-head-link dropdown-toggle arrow-none me-0 cust-btn" data-size="lg"
                                ...
                                <span class="drp-text hide-mob"><?php echo e(__('Create New Store')); ?>
            ...
            <?php endif; ?>
               <li class="dropdown dash-h-item drp-language">
                            <a target="_blank" href="<?php echo e($store_id['store_url']); ?>" class="dash-head-link dropdown-toggle arrow-none me-0 cust-btn"><i class="fas fa-eye"></i> <span class="drp-text hide-mob"><?php echo e(__('View Store')); ?></span></a>
                        </li>      
            <?php if(Auth::user()->type != 'super admin'): ?>
                <li class="dropdown dash-h-item drp-language">
...
<!-- [ Header ] end -->
<?php /**PATH /home/bsswhats/public_html/resources/views/partials/admin/header.blade.php ENDPATH**/ ?>