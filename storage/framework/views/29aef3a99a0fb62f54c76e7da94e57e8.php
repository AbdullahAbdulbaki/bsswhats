                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('feature_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" data-title="<?php echo e(__('Create Feature')); ?>" title="<?php echo e(__('Create Feature')); ?>" class="btn btn-sm btn-primary">
                                                        ...
                                                        <span>
                                                            <div class="action-btn ms-2">
                                                                <a href="#"
                                                                    ...
                                                                    data-ajax-popup="true" data-title="<?php echo e(__('Edit Feature')); ?>"
                                                                    data-size="lg" data-bs-toggle="tooltip"
                                                                    title="<?php echo e(__('Edit Feature')); ?>"
                                                                    data-original-title="<?php echo e(__('Edit Feature')); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="logo-content mt-4">
                                            <img id="image1"
                                                src="<?php echo e($logo . '/' . $settings['highlight_feature_image'] . '?timestamp=' . time()); ?>"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('features_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" data-title="<?php echo e(__('Create Feature Block')); ?>" title="<?php echo e(__('Create Feature Block')); ?>" class="btn btn-sm btn-primary">
                                        <i class="ti ti-plus text-light"></i>
                                    </a>
                                </div>
                            </div>
                                                        ...
                                                        <span>
                                                            <div class="action-btn ms-2">
                                                                <a href="#"
                                                                    ...
                                                                    data-ajax-popup="true" data-title="<?php echo e(__('Edit Feature Block')); ?>"
                                                                    data-size="lg" data-bs-toggle="tooltip"
                                                                    title="<?php echo e(__('Edit Feature Block')); ?>"
                                                                    data-original-title="<?php echo e(__('Edit Feature Block')); ?>">
                                                                    <i class="ti ti-pencil"></i>
                                                                </a>
                                                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsswhats/public_html/Modules/LandingPage/Resources/views/landingpage/features/index.blade.php ENDPATH**/ ?>