...
use App\Http\Controllers\PaymentHistoriesController;
...
Route::group(['middleware' => ['verified']], function () {
    //Route::get('/', [DashboardController::class, 'index'])->middleware(['auth', 'XSS'])->name('');
    ...
    Route::middleware(['auth', 'XSS'])->group(function () {
        ...
        Route::get('payment_histories', [PaymentHistoriesController::class, 'index'])->name('payment_histories.index');
        Route::get('earnings', [EarningsController::class, 'index'])->name('earnings.index');

        # affiliate routes
        Route::group(['prefix' => 'affiliate'], function () {
            # configurations
            Route::get('/configurations', [ConfigurationsController::class, 'index'])->name('affiliate.configurations');
            Route::post('configurations', [ConfigurationsController::class, 'store'])->name('affiliate.configurations.store');
    ...
    Route::get('import/coupon/file', [ProductCouponController::class, 'importFile'])->name('coupon.file.import')->middleware('auth', 'XSS');;
    Route::post('import/coupon', [ProductCouponController::class, 'import'])->name('coupon.import')->middleware('auth', 'XSS');;
    Route::get('export/coupon', [ProductCouponController::class, 'export'])->name('coupon.export');

    ////////////////////

    Route::get('product/import/export', [ProductController::class, 'fileImportExport'])->name('product.file.import')->middleware('auth', 'XSS');;
    Route::post('product/import', [ProductController::class, 'fileImport'])->name('product.import')->middleware('auth', 'XSS');;
...
Route::get('/blog/{id}',[BlogController::class,'show_blog'])->name('apps.show_blog');

// blog Category Backend
    Route::resource('blog_categories', BlogCategoryController::class);
    Route::resource('blog_backend', BackendBlogController::class);
// End blog
Route::get('/change-lang', [LanguageController::class, 'changeLangfront'])->name('changeLangfront');
